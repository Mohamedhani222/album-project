                ...
                <div class="card z-index-0">
                    ...
                    <div class="card-body">
                            ...
                            <div class="alert alert-danger">
                                <ul>
                                    @foreach ($errors->all() as $error)
                                        <li style="color: white" t>{{ $error }}</li>
                                    @endforeach
                                </ul>
                            </div>
                        @endif
                        ...
                        <form method="post" action="{{route('register')}}">
                            ...
                            <div class="mb-3">
                                <input type="password" name="password_confirmation" class="form-control" placeholder="repeat password" aria-label="Password" aria-describedby="password-addon">
                            </div>
